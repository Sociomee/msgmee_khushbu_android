...
class RecieverChat : AppCompatActivity() {
...
// and add alarm
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_reciever_chat)
        ...
        mAddPersonFab.setOnClickListener(
            View.OnClickListener {
                val intent = Intent(this@RecieverChat , AttachContact::class.java)
                startActivity(intent)
            })

        media_fab.setOnClickListener(View.OnClickListener {
            val intent = Intent(this@RecieverChat , Gallery::class.java)
            startActivity(intent)
        })

        mAddAlarmFab.setOnClickListener(
            View.OnClickListener {
                val intent = Intent(this@RecieverChat , SendChatDocs::class.java)
                startActivity(intent)
            })
// _________________--------------------_____Fab_____________________________________
    }
    ...
    fun back(view: View) {
        val intent = Intent(this@RecieverChat , ForwardMessage::class.java)
        startActivity(intent)
    }
}