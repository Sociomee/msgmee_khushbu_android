...
class BizpageName : AppCompatActivity() {
...
// and add alarm
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_bizpage_name)
        ...
        dots.setOnClickListener(View.OnClickListener {
            ...
            val view: View = LayoutInflater.from(applicationContext).inflate(R.layout.bottom_slider_bizpage, null)
...
// _________________--------------------_____Fab_____________________________________
    ...
    fun back(view: View) {
        val intent = Intent(this@BizpageName , BizpageChat::class.java)
        startActivity(intent)
    }
}